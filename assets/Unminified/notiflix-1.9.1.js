...
var Notiflix = {
    ...
    Notify: {
        ...
        // Display Notification: Custom
        UserCustom: function (message, callback) {
            ...
            var theType = newNotifySettings.usercustom;
            NotiflixNotify(message, callback, theType, 'UserCustom');
    ...
    if (arguments != undefined && arguments.length === 4) {
        ...
        if (newNotifySettings.useIcon) {
            ...
            if (newNotifySettings.useFontAwesome) { // use font awesome
                ...
                } else if (staticType === 'UserCustom') { // usercustom
