...
var Contrast = ['darken-1', 'darken-1', 'darken-2', 'darken-3', 'darken-4',
    'lighten-1', 'lighten-2', 'lighten-3', 'lighten-4', 'lighten-5'];

var colors = ['materialize-red', 'red', 'pink', 'purple', 'deep-purple', 'indigo',
...
module.exports = {
    ...
    getAllCssClasses: () => {
        return [].concat(...[...document.querySelectorAll('*')].map(e =>
            [...e.classList])).filter((d, i, a) => a.indexOf(d) == i).sort()
    },
